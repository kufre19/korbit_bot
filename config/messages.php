...
return [
    ...
    "get_trained" => <<<MSG
    Gain access to a million-dollar opportunity and receive personalized one-on-one training from the experts at KorbitBot 
    Arbitrage.
    
    Our one-on-one training is a great way to learn what has been hidden for years by the crypto gurus. 
    
    For our clients, we have a private chat available during their use of the service where experienced arbitrageurs are 
    available to assist and share interesting earning strategies.
    
    We have been actively engaged in the world of arbitrage since 2015, accumulating substantial experience and witnessing 
    countless instances of successful ventures. This extensive background has motivated us to develop a comprehensive training 
    course tailored to equip you with the necessary skills and strategies. We are thrilled to offer this valuable course at a 
    modest price, ensuring accessibility for aspiring arbitrage enthusiasts like yourself.
